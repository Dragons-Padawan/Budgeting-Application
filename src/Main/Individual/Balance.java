...
public class Balance {
    ...
    public static void balanceReturn(String filename) throws IOException {
        ...
        String lineTwelve = "|\t\t\t\t\t\t|\t\t\t| Credit Cards\t\t\t\t| \t$" + Expenses.expenses.get("Credit Cards") + " \t\n";
        String lineThirteen = "|\t\t\t\t\t\t|\t\t\t| Miscellaneous\t\t\t\t| \t$" + Expenses.expenses.get("Miscellaneous") + " \t\n";
        String lineFourteen = "|\t\t\t\t\t\t|\t\t\t| Personal Care\t\t\t\t| \t$" + Expenses.expenses.get("Personal Care") + " \t\n";
        String lineFifteen =  "|\t\tTotal Income\t\t\t| \t$" + Income.getAnnualIncome() + "\t|\t\tTotal Expenses\t\t| \t$" + Expenses.getAnnualExpenses() + "\t|\n";
        String lineSixteen = "|\t\t\t\t\t\t\t\t\t\t\tAnnual Balance\t\t| \t$" + getBalance() + "\t\t|\n";
