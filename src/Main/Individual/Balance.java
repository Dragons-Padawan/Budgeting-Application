...
public class Balance {
    ...
    public static void result() {
        ...
        lineOne = " Salary\t\t\t\t\t|\t$" + Income.getAnnualIncome() + "\t| Mortgage\t\t\t\t|\t$" + Expenses.expenses.get("Mortgage") + "\t\n";
        lineTwo = "\t\t\t\t\t\t|\t\t\t| Electricity\t\t\t\t| \t$" + Expenses.expenses.get("Electricity") + "\t\t\n";
        lineThree = "\t\t\t\t\t\t|\t\t\t| Natural Gas\t\t\t| \t$" + Expenses.expenses.get("Gas") + "\t\n";
        lineFour = "\t\t\t\t\t\t|\t\t\t| Water\t\t\t\t\t| \t$" + Expenses.expenses.get("Water") + "  \t\n";
        lineFive = "\t\t\t\t\t\t|\t\t\t| Internet\t\t\t\t| \t$" + Expenses.expenses.get("Internet") + " \t\n";
        lineSix = "\t\t\t\t\t\t|\t\t\t| Cable\t\t\t\t\t| \t$" + Expenses.expenses.get("Cable") + " \t\n";
        lineSeven = "\t\t\t\t\t\t|\t\t\t| Food\t\t\t\t\t| \t$" + Expenses.expenses.get("Food") + " \t\n";
        lineEight = "\t\t\t\t\t\t|\t\t\t| HealthCare\t\t\t\t| \t$" + Expenses.expenses.get("HealthCare") + " \t\n";
        lineNine = "\t\t\t\t\t\t|\t\t\t| Entertainment\t\t\t\t| \t$" + Expenses.expenses.get("Entertainment") + "\t\n";
        lineTen = "\t\t\t\t\t\t|\t\t\t| Clothes\t\t\t\t| \t$" + Expenses.expenses.get("Clothes") + " \t\n";
        lineEleven = "\t\t\t\t\t\t|\t\t\t| Education\t\t\t\t| \t$" + Expenses.expenses.get("Education") + " \t\n";
        lineTwelve = "\t\t\t\t\t\t|\t\t\t| Credit Cards\t\t\t\t| \t$" + Expenses.expenses.get("Credit Cards") + " \t\n";
        lineThirteen = "\t\t\t\t\t\t|\t\t\t| Miscellaneous\t\t\t\t| \t$" + Expenses.expenses.get("Miscellaneous") + " \t\n";
        lineFourteen = "\t\t\t\t\t\t|\t\t\t| Personal Care\t\t\t\t| \t$" + Expenses.expenses.get("Personal Care") + " \t\n";
        lineFifteen = "\t\tTotal Income\t\t\t| \t$" + Income.getAnnualIncome() + "\t|\t\tTotal Expenses\t\t| \t$" + Expenses.getAnnualExpenses() + "\t\n";
        lineSixteen = "\t\t\t\t\t\t\t\t\t\t\tAnnual Balance\t\t| \t$" + getBalance() + "\t\t\n";
    }
